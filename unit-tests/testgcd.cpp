...
struct GcdFixture : public AbcFixture {
    const BasePtr zeroAfterExpansion =
...
{
    const BasePtr u =
      Sum::create(four, Product::create(a, Sum::create(b, two)), Product::minus(a, b), Product::minus(two, a));
...
/* Gcd(-a^2*b + b^3, a^2*b + 2*a*b^2) = b. */
{
    ...
    const BasePtr v = Sum::create(Product::create(b, aSquare), Product::create(two, Power::create(b, two), a));
...
/* Example 6.62 in Cohen [2003]. */
{
    ...
    const BasePtr u = Sum::create(Product::minus(b, aSquare), Power::create(b, three));
    const BasePtr v =
      Sum::create(Product::create(b, aSquare), Product::create(two, Power::create(b, two), a), bPowerThree);
 ...
 * integer coefficients in the case of the listed CAS. */
{
    ...
    v = Sum::create(Product::create(a, c, d), Product::minus(two, Power::create(a, three), Power::create(d, two)),
...
/* Gcd(3*a^3*b + 3*a^2*b*c^5, 14*a^2 + 14*a*c^5) = a^2 + a*c^5). */
{
    ...
    const BasePtr v = Sum::create(
      Product::create(Numeric::create(14), a, a), Product::create(Numeric::create(14), a, Power::create(c, five)));
    const BasePtr expected = Sum::create(Power::create(a, two), Product::create(a, Power::create(c, five)));
...
BOOST_AUTO_TEST_CASE(largeMultivarPoly, *label("expensive"))
{
    ...
    aux[0] = Sum::create(Product::create(five, Power::create(a, two), Power::create(e, four), Product::create(d, f)),
      Product::create(three, a, Power::create(g, three), h),
      Product::create(seven, Power::create(a, two), Power::create(c, three), Product::create(b, e, h)));
    aux[1] = Sum::create(a, Product::minus(two, b, d), Power::create(h, five));
    aux[2] = Sum::create(
      Product::create(Product::create(four, e), Power::create(d, three), Power::create(c, five), Power::create(d, two)),
      Product::create(Product::create(Numeric::create(-3), c), Power::create(d, three), Power::create(e, four),
        Power::create(h, two)),
      Product::create(two, a));
    aux[3] = Sum::create(Product::create(nine, a, Power::create(b, two), Power::create(c, two)),
      Product::create(Numeric::create(-5), Power::create(g, five), f, Power::create(d, three)),
